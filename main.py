...
#
#
# image1 = dlib.load_rgb_image(str(Path.cwd()) + '/Testimages/image1.jpg')
# image2 = dlib.load_rgb_image(str(Path.cwd()) + '/Testimages/image5.jpg')
# compare_faces(image1, image2)

image1 = str(Path.cwd()) + '/Testimages'